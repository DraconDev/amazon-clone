export const appInitialState = {
	...
	imageLinks: {
		...
		mainLogo: "http://pngimg.com/uploads/amazon/amazon_PNG25.png",
		carousel: [
			{
				description: "",
				image:
			...
			},
			{
				description: "",
				image:
					"https://images.unsplash.com/photo-1445205170230-053b83016050?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1351&q=80",
			},
			{
				description: "",
				image:
